...
class piano_window(pyglet.window.Window):
    ...
    def on_close(self):
        ...
        pyglet.clock.unschedule(current_piano_engine._midi_show_finished)
        if not piano_config.use_soundfont:
            ...
            pyglet.clock.unschedule(current_piano_engine.start_play_sf2)
        self.close()
...
def start():
    ...
    current_piano_window.mode_num = 2
